import PlayerStatsWindow from "../components/PlayerStatsWindow";
...
function MatchUIHead() {
   ...
   return (
      <div id="matchuihead" className="flex w-full bg-dark-background p-0 sm:p-2 md:p-4">
         <PlayerStatsWindow player={match.players.host} />
         ...
         <PlayerStatsWindow player={match.players.guest} />
      </div>
   );
}
