...
function PlayerlistCard() {
   ...
   return (
      <Card>
         ...
         <div className="flex w-full justify-between text-center text-white-default">
            ...
            <ul className="mt-8 flex w-full flex-grow flex-col items-center gap-2 overflow-auto">
               {list.ready
                  ...
                  .map((player) => {
                     ...
                     return (
                        <li
                           className="flex h-10 w-full cursor-pointer items-center justify-between rounded-md border-[1px] border-zinc-900 text-center text-sm text-white-default transition-all hover:border-zinc-500"
